...
| `mem` | — | Consulta `sys_memstatus` e imprime memoria total/usada/libre y bloques asignados.
...
| --- | --- | --- |
| `test_mm` | `<max_memory>` | Stress del memory manager: reserva/libera bloques hasta el límite pedido y reporta `sys_memstatus`.
